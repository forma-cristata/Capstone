  ...
  void selectEffect(int effectNumber, int delayTime = -1) {
    ...
    switch (effectNumber) {
      ...
      case 1:                                                                                         // stillMany
        ...
        break;
      case 2:  // traceOne
        setEffect(new TraceOneEffect(ledController, pattern5, (delayTime == -1) ? 10 : delayTime));
        break;
      case 3:  // progressive
      ...
      case 6:  // comfortSongStrobe
        setEffect(new ComfortSongStrobeEffect(ledController, pattern6, (delayTime == -1) ? 3 : delayTime));
        break;
      case 7:  // blender
        setEffect(new BlenderEffect(ledController, pattern6, (delayTime == -1) ? 2 : delayTime));
        break;
      case 8:  // techno
        setEffect(new TechnoEffect(ledController, pattern4, (delayTime == -1) ? 1 : delayTime));
        break;
      case 9:  // trance
